/*
  plcLib Version 0.6, last updated 7th July, 2013.
...
unsigned int timerPulse(unsigned long &timer1State, unsigned long timer1Period, unsigned long &timer2State, unsigned long timer2Period);
